...
export const getTrendingAnime = async (perPage = 20, page = 1) => {
    ...
    if (stillValid) {
        return cache.map((anime) => ({
            ...
            genres: anime.genres,
            startDate: {
                start_month: anime.start_month,
                start_day: anime.start_day,
                start_year: anime.start_year,
            },
            endDate: {
                end_month: anime.end_month,
                end_day: anime.end_day,
    ...
    const insertData = freshData.map((a) => ({
        ...
        genres: a.genres,
        start_month: a.startDate.month,
        start_day: a.startDate.day,
        start_year: a.startDate.year,
        end_month: a.endDate.month,
        end_day: a.endDate.day,
        end_year: a.endDate.year,
