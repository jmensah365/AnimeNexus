...
const TrendingModal = ({ modalData, onClose }) => {
                                    ...
                                    >
                                        ...
                                        <div className="bg-gray-800/30 rounded-lg p-6 border border-gray-700/30">
                                            ...
                                            <p className="text-gray-300 leading-relaxed">
                                                {stripHtml(modalData.description) || 'No synopsis available for this anime.'}
                                            </p>
                                        </div>
                                        ...
                                        <div className="flex flex-col sm:flex-row gap-4">
                                            <div className="flex-1 bg-gray-800/30 rounded-lg p-4 border border-gray-700/30">
                                                ...
                                                <span className="text-white font-medium">
                                                    {formatMonth(modalData.startDate.start_month) + ' ' + modalData.startDate.start_day + ', ' + modalData.startDate.start_year}
                                                </span>
                                            </div>
                                            ...
                                            {/* <div className="flex-1 bg-gray-800/30 rounded-lg p-4 border border-gray-700/30">
                                                ...
                                                {/* <span className='text-white font-medium'>
                                                    {formatMonth(modalData.startDate.start_month) + ' ' + modalData.endDate.end_day + ', ' + modalData.endDate.end_year}
                                                </span> 
