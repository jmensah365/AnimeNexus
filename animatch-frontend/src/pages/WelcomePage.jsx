    ...
    <>
      ...
      <div className="relative w-full h-screen overflow-scroll bg-black">
        ...
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white animate-fade-down bg-black/40">
          ...
          <button
            onClick={() => handleClick()}
            className={`relative border hover:border-red-600 duration-500 group cursor-pointer text-sky-50 overflow-hidden h-20 w-56 rounded-md bg-red-800 p-2 flex justify-center items-center font-extrabold mt-3 ${genAndInsertAIRecs.isPending ? 'animate-pulse' : 'animate-none'
              }`}
          >
