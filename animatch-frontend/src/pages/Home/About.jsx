        ...
        <>
            ...
            <HomeNavBar />
                <div className="flex items-center justify-center">
                    <div className="max-w-4xl mx-auto p-6 text-white mt-30">
                        <motion.div
                            initial="hidden"
                            animate="visible"
                            variants={containerVariants}
                            className="mb-12 text-center bg-black/50 rounded-2xl p-4"
                        >
                        ...
                        <motion.div
                            ...
                            animate="visible"
                            variants={containerVariants}
                            className="grid grid-cols-2 md:grid-rows-4 gap-6"
                        >
                            <motion.div
